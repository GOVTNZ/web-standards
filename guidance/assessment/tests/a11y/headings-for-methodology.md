...
1. On the page you’re testing, go to the Web Developer extension and select 'Outline', then click:
...
2. Record a failure, noting the reason, if content is outlined as a heading, but doesn't: 
